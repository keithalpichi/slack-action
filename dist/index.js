...
var BaseGithubSlackAdapter = /** @class */ (function () {
    ...
    BaseGithubSlackAdapter.prototype.statusVerb = function (status, pastTense) {
        if (!status) {
            return '';
        }
        switch (status) {
    ...
    BaseGithubSlackAdapter.prototype.statusAdverb = function (status) {
        if (!status) {
            return '';
        }
        switch (status) {
    ...
    BaseGithubSlackAdapter.prototype.stepsSection = function () {
        ...
        return new slack_1.SectionBlock([this.stepsSummary(this.inputs.steps)]);
    };
    BaseGithubSlackAdapter.prototype.stepsSummary = function (steps) {
        var summary = [];
        for (var _i = 0, _a = Object.entries(steps); _i < _a.length; _i++) {
            var _b = _a[_i], name_1 = _b[0], step = _b[1];
            summary.push(this.stepSummary(name_1, step));
        }
        return summary.join('\n');
    };
    BaseGithubSlackAdapter.prototype.stepSummary = function (name, step) {
        return slack_1.Markdown.stepIcon(step.outcome) + ": " + name;
    };
    BaseGithubSlackAdapter.prototype.divider = function () {
...
exports.BaseGithubSlackAdapter = BaseGithubSlackAdapter;
